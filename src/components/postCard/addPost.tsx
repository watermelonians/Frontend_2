...
const AddPost = ({ showModal, setShowModal, addCard }) => {
  ...
  return (
    <div className={`fixed inset-20 z-50 ${showModal ? '' : 'hidden'}`}>
      ...
      <div ref={modalRef} className="flex flex-col dark:bg-[#050C28] bg-[#E3EFFB] bg-gradient-to-r from-[#0B6BCB04] to-[#0B6BCB13] rounded-lg p-8 m-4 max-w-3xl max-h-150 mx-auto relative z-50 shadow-1 dark:shadow-[#EDF5FD] shadow-[#050C28]">
        <div className="mb-4">
        ...
        <div className="mb-4">
          <div className='flex flex-row'>
            ...
            <button 
              className="dark:bg-[#0A2744] bg-[#E3EFFB] dark:text-[#C7DFF7] text-[#12467B] p-2 rounded text-xs font-semibold flex justify-end"
