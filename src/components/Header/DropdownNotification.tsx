  ...
  return (
    <li className="relative">
      <Link
        ...
        href="#"
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-lg border-[0.5px] border-stroke bg-[#0B6BCB] hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
      >
        <span
