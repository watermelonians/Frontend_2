  ...
  return (
    <li className="relative">
      <Link
        ...
        href="#"
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-lg border-[0.5px] border-stroke bg-[#0B6BCB] hover:text-primary dark:border-strokedark dark:bg-[#0B6BCB] dark:text-white"
      >
        <span
        ...
        <svg
          className=" fill-white duration-300 ease-in-ou"
          width="12"
          height="16"
          viewBox="0 0 18 18"
          fill="none"
