...
const PostCard: React.FC<PostCardProps> = ({
  ...
  return (
    <div className="rounded-md dark:bg-[#0A274440] bg-[#E3EFFB] bg-gradient-to-r from-[#0B6BCB04] to-[#0B6BCB13] flex flex-col items-start justify-start p-2 box-border gap-[8px] text-left text-xs text-neutral-soft-bg font-components-buttons-lg self-stretch w-full md:w-[90] cursor-pointer" onClick={onClick}>
