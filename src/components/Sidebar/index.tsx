...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 m-2 flex h-auto w-fit flex-col overflow-x-hidden overflow-y-hidden rounded-2xl bg-gradient-to-b from-[#0B6BCB06] to-[#0B6BCB20] shadow-2xl duration-300 ease-linear lg:static lg:translate-x-0 ${
      ...
      <div className="m-2">
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <nav className="mt-2 px-1 lg:mt-3 lg:px-4">
            {/* <!-- My Spaces Group --> */}
            <div>
              <div className="mb-2 text-lg font-bold text-black-2 dark:text-bodydark1">
                My Spaces
              </div>
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  <Link
                    href="/Overview"
                    className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-1 font-medium text-black-2 duration-300 ease-in-out hover:bg-sky-400 focus:bg-sky-400 active:bg-sky-400 dark:text-bodydark1 dark:hover:bg-sky-400 ${
                      pathname.includes("/Overview") &&
                      "bg-sky-400 dark:bg-meta-4"
                    }`}
                  >
                    <div className="flex h-6 w-6 items-center gap-4 rounded-md bg-blue-500 p-1.5">
                      <svg
                        width="20"
                        height="13"
                        viewBox="0 0 15 15"
          ...
          <ul className="mb-6 flex flex-col gap-1.5">
            ...
            <li>
              <Link
                href="/profile"
                className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-1 font-medium text-black-2 duration-300 ease-in-out hover:bg-sky-400 focus:bg-sky-400 active:bg-sky-400 dark:text-bodydark1 dark:hover:bg-sky-400 ${
                  pathname.includes("profile") && "bg-sky-400 dark:bg-meta-4"
                }`}
              >
                <div className="flex h-6 w-6 items-center gap-4 rounded-md bg-blue-500 p-1.5">
                  <svg
            ...
            <li>
              <Link
                href="/settings"
                className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-1 font-medium text-black-2 duration-300 ease-in-out hover:bg-sky-400 focus:bg-sky-400 active:bg-sky-400 dark:text-bodydark1 dark:hover:bg-sky-400 ${
                  pathname.includes("settings") && "bg-sky-400 dark:bg-meta-4"
                }`}
              >
                <div className="flex h-6 w-6 items-center gap-4 rounded-md bg-blue-500 p-1.5">
                  <svg
            ...
            <li>
              <button
                ...
                className="group relative flex w-full items-center gap-2.5 rounded-sm px-4 py-1 font-medium text-black-2 duration-300 ease-in-out hover:bg-sky-400 focus:bg-sky-400 active:bg-sky-400
                  dark:text-bodydark1 dark:hover:bg-sky-400 "
              >
                <div className="flex h-6 w-6 items-center gap-4 rounded-md bg-blue-500 p-1.5">
                  <svg
                    width="16"
