...
const SuggestionCard: React.FC<SuggestionCardProps> = ({
  ...
  return (
    <div className="flex flex-col col-span-1 rounded-lg bg-gradient-to-r from-[#0B6BCB06] to-[#0B6BCB20] p-3 text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white">
