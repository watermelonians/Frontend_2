...
const RatioRepresentation: React.FC<RatioRepresentationProps> = ({
  ...
  return (
    <Card className="flex flex-row bg-gradient-to-r from-[#0B6BCB06] to-[#0B6BCB20] rounded-xl">
      <div className="flex flex-col p-2">
        <div className="font-bold text-base text-black dark:text-white w-fit">{title}</div>
        <div className=" font-semibold text-sm text-black dark:text-white w-fit">{getLevel(value)}</div>
